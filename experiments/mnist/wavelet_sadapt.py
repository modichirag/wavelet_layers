...
from layers import CouplingLayer, WaveletLayer_sadapt
...
def create_wavelet_flow(use_vardeq=True, seed_init=99):
    ...
    for i in range(n_flow_layers):
        flow_layers += [WaveletLayer_sadapt(D=D, L=L, c_hidden=c_hidden, renorm=renorm, key=key_init)]
